...
local functionInfo = {kata
    ["script"] = {
        ["SourceScript"] = game:GetService("Players").LocalPlayer:WaitForChild("Use"),
        ["CallingScript"] = game:GetService("Players").LocalPlayer:WaitForChild("Use")
    },
    ["upvalues"] = {},
    ["info"] = {
        ["is_vararg"] = 0,
        ["nups"] = 0,
        ["short_src"] = "Players.baobayacc1203.Backpack.Real Triple Katana.RealTrippleKatana.Skill1b.Z.TextButton.Use",
        ["what"] = "Lua",
        ["currentline"] = 11,
        ["numparams"] = 0,
        ["func"] = function: 0x480440fa08486828,
        ["source"] = "=Players.baobayacc1203.Backpack.Real Triple Katana.RealTrippleKatana.Skill1b.Z.TextButton.Use"
    },
    ["constants"] = {
        [1] = "Real Triple Katana",
        [2] = "game",
        [4] = "Players",
        [5] = "LocalPlayer",
        [6] = "Character",
